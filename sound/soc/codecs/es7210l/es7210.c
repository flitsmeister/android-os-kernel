...
static void es7210_unmute(void)
{
	...
	es7210_multi_chips_update_bits(ES7210_MIC1_GAIN_REG43, 0xff, 0x1A);
	es7210_multi_chips_update_bits(ES7210_MIC2_GAIN_REG44, 0xff, 0x1A);
	es7210_multi_chips_update_bits(ES7210_MIC3_GAIN_REG45, 0xff, 0x1A);
	es7210_multi_chips_update_bits(ES7210_MIC4_GAIN_REG46, 0xff, 0x1A);
}
