...
static void es7210_tdm_init_codec(u8 mode)
{
	...
	for (cnt = 0; cnt < ADC_DEV_MAXNUM; cnt++) {               
                /* Update to support es7210l */
                es7210_read(0x3f, &reg, i2c_clt1[i]);
                es7210_write(0x14, 0x00, i2c_clt1[i]);
                es7210_write(0x15, 0x00, i2c_clt1[i]);
				//es7210_write(0x45, 0x00, i2c_clt1[i]);
                if((reg>>4)&1){/* es7210l */
                        es7210_write(0x17, 0x10, i2c_clt1[i]);
                        es7210_write(0x41, 0x71, i2c_clt1[i]);
                        es7210_write(0x47, 0x06, i2c_clt1[i]);
                        es7210_write(0x48, 0x26, i2c_clt1[i]);
                        es7210_write(0x49, 0x06, i2c_clt1[i]);
                        es7210_write(0x4a, 0x26, i2c_clt1[i]);
                        es7210_write(0x42, 0x71, i2c_clt1[i]);
						//es7210_write(0x02, 0x81, i2c_clt1[i]);
                }else{/* es7210 */
                        es7210_write(0x17, 0x00, i2c_clt1[i]);
                        es7210_write(0x41, 0x70, i2c_clt1[i]);
                        es7210_write(0x42, 0x70, i2c_clt1[i]);
                        es7210_write(0x47, 0x08, i2c_clt1[i]);
                        es7210_write(0x48, 0x08, i2c_clt1[i]);
                        es7210_write(0x49, 0x08, i2c_clt1[i]);
                        es7210_write(0x4a, 0x3c, i2c_clt1[i]);
                }                
        }
