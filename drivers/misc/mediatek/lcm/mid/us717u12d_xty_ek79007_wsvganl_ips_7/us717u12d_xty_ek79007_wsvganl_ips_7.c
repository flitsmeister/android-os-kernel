...
static void lcm_get_params(struct LCM_PARAMS *params)
{
    ...
    params->dsi.vertical_backporch                              = 23; //10; //16;
    params->dsi.vertical_frontporch                             = 12;//5; 
    params->dsi.vertical_active_line                            = FRAME_HEIGHT; 

    params->dsi.horizontal_sync_active                          = 10; // 10; //5;//6;
    params->dsi.horizontal_backporch                            = 160; //60; //60; //80;
    params->dsi.horizontal_frontporch                           = 160; //60; 
...
struct LCM_DRIVER us717u12d_xty_ek79007_wsvganl_ips_7_lcm_drv =
{
    .name			= "us717u12d_xty_ek79007_wsvganl_ips_7",
