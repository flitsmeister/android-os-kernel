...
{	
   {0xE0,2,{0xAB,0xBA}},
    ...
    {0xB2,7,{0x08,0x18,0x04,0x50,0x50,0x14}},
...
struct LCM_DRIVER gs716_wdq_wd101wxm_boe_wxga_ips_101_lcm_drv = {
	.name = "gs716_wdq_wd101wxm_boe_wxga_ips_101",
