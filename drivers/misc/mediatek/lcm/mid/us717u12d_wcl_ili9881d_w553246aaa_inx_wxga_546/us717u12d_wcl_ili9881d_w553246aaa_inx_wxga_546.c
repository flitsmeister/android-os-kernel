...
static void lcm_get_params(struct LCM_PARAMS *params)
{
	...
	params->dsi.vertical_active_line = FRAME_HEIGHT; // 1280 + 15 + 16 + 6 = 1317

	params->dsi.horizontal_sync_active = 8;
	params->dsi.horizontal_backporch = 48;
	params->dsi.horizontal_frontporch = 52;
	params->dsi.horizontal_active_pixel = FRAME_WIDTH; // 720 + 48 + 52 + 8 = 828
...
struct LCM_DRIVER us717u12d_wcl_ili9881d_w553246aaa_inx_wxga_546_lcm_drv = 
{
    .name			= "us717u12d_wcl_ili9881d_w553246aaa_inx_wxga_546",
