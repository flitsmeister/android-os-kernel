...
//Page4
    ...
    dsi_set_cmdq(data_array, 1, 1);
    data_array[0] = 0x032D1500;//lansel select by internal reg
    dsi_set_cmdq(data_array, 1, 1);
    data_array[0] = 0x00E01500;
    dsi_set_cmdq(data_array, 1, 1);

    data_array[0] = 0x10701500;	//DC0,DC1
    dsi_set_cmdq(data_array, 1, 1);
    data_array[0] = 0x13711500;	//DC2,DC3
    dsi_set_cmdq(data_array, 1, 1);
...
//Set TCON
    data_array[0] = 0x06401500;	//RSO=800 Pixels
    dsi_set_cmdq(data_array, 1, 1);
...
//--- power voltage  ----//
    data_array[0] = 0x01551500;	//DCDCM=1111, External pwoer ic
    dsi_set_cmdq(data_array, 1, 1);
...
//SSD_Single(0x2C,0x06);
//SSD_Single(0x2D,0x0A);  
//SSD_Single(0x2E,0x07);
//SSD_Single(0x2F,0x0B);
//SSD_Single(0x30,0x09);
//SSD_Single(0x31,0x05);
//SSD_Single(0x32,0x08);
//SSD_Single(0x33,0x04);
//SSD_Single(0x34,0x10);
...
//SSD_Single(0x3B,0x17);
//SSD_Single(0x3C,0x37);
//SSD_Single(0x3D,0x1F);
//SSD_Single(0x3E,0x1E);
//SSD_Single(0x3F,0x1F);
//SSD_Single(0x40,0x00);
//SSD_Single(0x41,0x1F);

//GIP_R_GS Pin mapping
//SSD_Single(0x42,0x06);
//SSD_Single(0x43,0x0A);   
//SSD_Single(0x44,0x07); 
//SSD_Single(0x45,0x0B); 
//SSD_Single(0x46,0x09); 
//SSD_Single(0x47,0x05); 
//SSD_Single(0x48,0x08); 
//SSD_Single(0x49,0x04); 
//SSD_Single(0x4A,0x10); 
...
//SSD_Single(0x51,0x17); 
//SSD_Single(0x52,0x37); 
//SSD_Single(0x53,0x1F); 
//SSD_Single(0x54,0x1E); 
//SSD_Single(0x55,0x1F); 
//SSD_Single(0x56,0x00); 
...
struct LCM_DRIVER gs710_fx_jd9366_boe_wxganl_ips_101_lcm_drv = {
	.name = "gs710_fx_jd9366_boe_wxganl_ips_101",
