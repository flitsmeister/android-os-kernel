...
static void init_lcm_registers(void)
{
    ...
    data_array[0] = 0xAB801500;                       
    dsi_set_cmdq(data_array, 1, 1);                   
    MDELAY(1);                                        
   
   
    data_array[0] = 0xFF811500;                       
    dsi_set_cmdq(data_array, 1, 1);                   
    MDELAY(1);                                        
    
	
    data_array[0] = 0x77821500;                       
    dsi_set_cmdq(data_array, 1, 1);                   
    MDELAY(1);                                        
    ...
    data_array[0] = 0x84841500;
    dsi_set_cmdq(data_array, 1, 1);
    MDELAY(1);
    
    data_array[0] = 0xCB851500;
    dsi_set_cmdq(data_array, 1, 1);
    MDELAY(1);
...
static void lcm_get_params(struct LCM_PARAMS *params)
{
    ...
    params->dsi.mode    = BURST_VDO_MODE;//BURST_VDO_MODE;SYNC_EVENT_VDO_MODE
...
struct LCM_DRIVER gs705_ek79007_lcm_drv = {
	.name = "gs705_ek79007",
