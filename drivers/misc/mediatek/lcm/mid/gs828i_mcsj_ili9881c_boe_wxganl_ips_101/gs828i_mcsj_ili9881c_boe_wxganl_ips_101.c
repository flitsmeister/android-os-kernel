...
static void lcm_get_params(struct LCM_PARAMS *params)
{
    ...
    params->dsi.vertical_sync_active                            = 35; //2; //4;
    params->dsi.vertical_backporch                              = 38; //10; //16;
    params->dsi.vertical_frontporch                             = 54;//5; 
...
static void lcd_violcm_en(unsigned char enabled)
{
	lcm_set_gpio_output(GPIO_LCM_1V8_EN, enabled);
}
...
{
	lcm_set_gpio_output(GPIO_LCM_3V3_EN, enabled);
}
static void lcd_dsi_te_en(unsigned char enabled)
{
	lcm_set_gpio_output(GPIO_LCM_DSI_TE_EN, enabled);
}
...
static void lcm_init_lcm(void)
{
	lcd_3v3_en(1);	
	MDELAY(30);
	lcd_violcm_en(1);//LCD 3.3V
	MDELAY(30);
	lcd_dsi_te_en(1);
	MDELAY(30);
	avdd_enable(1);//bias en
	MDELAY(30);
...
struct LCM_DRIVER gs828i_mcsj_ili9881c_boe_wxganl_ips_101_lcm_drv = {
	.name = "gs828i_mcsj_ili9881c_boe_wxganl_ips_101",
