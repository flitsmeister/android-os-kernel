...
extern unsigned int GPIO_LCM_PWR_EN;//3.3
extern unsigned int GPIO_LCM_VDD;//1.8
...
struct LCM_DRIVER pf163_xlx_ili9881c_boe_wxga_101_lcm_drv = 
{
    .name			= "pf163_xlx_ili9881c_boe_wxga_101",
