...
static void lcm_get_params(struct LCM_PARAMS *params)
{
    ...
    params->dsi.vertical_backporch                              = 24; //10; //16;
    params->dsi.vertical_frontporch                             = 24;//5; 
    params->dsi.vertical_active_line                            = FRAME_HEIGHT;

    params->dsi.horizontal_sync_active                          = 32; // 10; //5;//6;
    params->dsi.horizontal_backporch                            = 68; //60; //60; //80;
    params->dsi.horizontal_frontporch                           = 68; //60; 
...
struct LCM_DRIVER us960_sat_jd9365da_h3_inx_wxganl_ips_101_lcm_drv =
{
    .name			= "us960_sat_jd9365da_h3_inx_wxganl_ips_101",
