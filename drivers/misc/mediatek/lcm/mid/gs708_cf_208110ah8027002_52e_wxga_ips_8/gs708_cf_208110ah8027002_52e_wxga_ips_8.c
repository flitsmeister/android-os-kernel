...
static struct LCM_setting_table lcm_initialization_setting[] = 
{
    ...
    {0xE1, 0x02, {0xBA, 0xAB} },
    {0xB0, 0x01, {0x00} },
    {0xB1, 0x04, {0x10, 0x01, 0x47, 0xFF} },
    {0xB2, 0x06, {0x1E, 0x14, 0x04, 0x50, 0x50, 0x14} },
    {0xB3, 0x03, {0x56, 0xD3, 0x00} },
    {0xB4, 0x03, {0x22, 0x30, 0x04} },
    {0xB5, 0x01, {0x00} },
    {0xB6, 0x07, {0x00, 0x00, 0x00, 0x10, 0x00, 0x10, 0x00} },
    {0xB7, 0x08, {0x0E, 0x00, 0xFF, 0x08, 0x08, 0xFF, 0xFF, 0x00} },
    {0xB8, 0x07, {0x16, 0x12, 0x29, 0x49, 0x48, 0x00, 0x00} },
    {0xB9, 0x26, {0x7C, 0x50, 0x44, 0x35, 0x32, 0x24, 0x2B, 0x18, 0x35, 0x36, 0x3A, 0x5A, 0x4A, 0x54, 0x47, 0x45, 0x38, 0x29, 0x06, 0x7C, 0x50, 0x44, 0x35, 0x32, 0x24, 0x2B, 0x18, 0x35, 0x36, 0x3A, 0x5A, 0x4A, 0x54, 0x47, 0x45, 0x38, 0x29, 0x06} },
    {0xBA, 0x08, {0x00, 0x00, 0x00, 0x44, 0x24, 0x00, 0x00, 0x00} },
    {0xBB, 0x03, {0x76, 0x00, 0x00} },
    {0xBC, 0x02, {0x00, 0x00} },
    {0xBD, 0x05, {0xFF, 0x00, 0x00, 0x00, 0x00} },
    {0xBE, 0x01, {0x00} },
    {0xC0, 0x10, {0x21, 0x98, 0x12, 0x34, 0x11, 0x44, 0x44, 0x44,0x10, 0x10, 0x90, 0x10, 0x0F, 0x00, 0x00, 0x00} },
    {0xC1, 0x0A, {0x11, 0x54, 0x02, 0x85, 0x10, 0x10, 0x90, 0x10, 0x54, 0x00} },
    {0xC2, 0x0C, {0x03, 0x09, 0x08, 0x89, 0x08, 0x10, 0x22, 0x10, 0x44, 0xF7, 0x18, 0x00} },
    {0xC3, 0x16, {0x8C, 0x4C, 0x0D, 0x0D, 0x0E, 0x0E, 0x0F, 0x0F, 0x02, 0x02, 0x02, 0x02, 0x02, 0x02, 0x02, 0x1E, 0x1E, 0x1F, 0x1F, 0x04, 0x24, 0x24} },
    {0xC4, 0x16, {0x0C, 0x0C, 0x0D, 0x0D, 0x0E, 0x0E, 0x0F, 0x0F, 0x02, 0x02, 0x02, 0x02, 0x02, 0x02, 0x02, 0x1E, 0x1E, 0x1F, 0x1F, 0x04, 0x24, 0x24} },
    ...
    {0xC8, 0x06, {0x21, 0x00, 0x32, 0x43, 0x54, 0x16} },
    {0xC9, 0x05, {0xA1, 0x22, 0xFF, 0x44, 0x23} },
    {0xCA, 0x02, {0xCB, 0x43} },
    {0xCC, 0x04, {0x2E, 0x02, 0x04, 0x08} },
    {0xCD, 0x08, {0x0E, 0x4B, 0x4B, 0x20, 0x23, 0x6B, 0x06, 0x83} },
    {0xD0, 0x03, {0x0F, 0x10, 0x80} },
    {0xD1, 0x04, {0x00, 0x0D, 0xFF, 0x0F} },
    {0xD2, 0x04, {0xE3, 0x2B, 0x38, 0x00} },
    {0xD4, 0x0B, {0x00, 0x01, 0x00, 0x0E, 0x04, 0x44, 0x08, 0x10, 0x00, 0x27, 0x00} },
    {0xD5, 0x01, {0x00} },
    {0xD6, 0x01, {0x00, 0x00} },
    ...
    {0xF3, 0x01, {0x03} },
    {0xF4, 0x1A, {0xFF, 0xFD, 0xFC, 0xFA, 0xF8, 0xF4, 0xF0, 0xE8, 0xE0, 0xD0, 0xC0, 0xA0, 0x80, 0x7F, 0x5F, 0x3F, 0x2F, 0x1F, 0x17, 0x0F, 0x0B, 0x07, 0x05, 0x03, 0x01, 0x00} },
    {0xF5, 0x1A, {0xFF, 0xFD, 0xFC, 0xFA, 0xF8, 0xF4, 0xF0, 0xE8, 0xE0, 0xD0, 0xC0, 0xA0, 0x80, 0x7F, 0x5F, 0x3F, 0x2F, 0x1F, 0x17, 0x0F, 0x0B, 0x07, 0x05, 0x03, 0x01, 0x00} },
    {0xF6, 0x1A, {0xFF, 0xFD, 0xFC, 0xFA, 0xF8, 0xF4, 0xF0, 0xE8, 0xE0, 0xD0, 0xC0, 0xA0, 0x80, 0x7F, 0x5F, 0x3F, 0x2F, 0x1F, 0x17, 0x0F, 0x0B, 0x07, 0x05, 0x03, 0x01, 0x00} },
    {0xF7, 0x07, {0x30, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00} },
    {0xF8, 0x07, {0x30, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00} },
    {0xF9, 0x07, {0x30, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00} },
...
static void lcm_get_params(struct LCM_PARAMS *params)
{
    ...
    params->dsi.vertical_backporch                              = 30; //10; //16;
...
struct LCM_DRIVER gs708_cf_208110ah8027002_52e_wxga_ips_8_lcm_drv = {
	.name = "gs708_cf_208110ah8027002_52e_wxga_ips_8",
