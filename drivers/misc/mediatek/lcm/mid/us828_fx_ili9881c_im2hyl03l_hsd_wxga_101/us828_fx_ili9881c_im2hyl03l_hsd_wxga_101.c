...
static void lcm_get_params(struct LCM_PARAMS *params)
{
	   memset(params, 0, sizeof(struct LCM_PARAMS));
		...
		params->dsi.horizontal_backporch				= 46;//62;	
		params->dsi.horizontal_frontporch			= 46;//80;
		params->dsi.horizontal_active_pixel 			= FRAME_WIDTH;
	
		params->dsi.PLL_CLOCK = 260;//400
}
...
struct LCM_DRIVER us828_fx_ili9881c_im2hyl03l_hsd_wxga_101_lcm_drv = 
{
    .name			= "us828_fx_ili9881c_im2hyl03l_hsd_wxga_101",
