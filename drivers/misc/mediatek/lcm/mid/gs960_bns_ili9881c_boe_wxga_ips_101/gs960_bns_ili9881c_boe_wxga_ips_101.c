...
static __attribute__((unused)) struct LCM_setting_table init_setting[] = {
	...
	{0x0d, 1, {0x00}},  
	{0x0e, 1, {0x00}},  
	{0x0f, 1, {0x25}},  //23  Detail A&B 4.0us
	{0x10, 1, {0x25}},  //23  Detail A&B 4.0us
	{0x11, 1, {0x00}},
	{0x12, 1, {0x00}},
	{0x13, 1, {0x00}},
	{0x14, 1, {0x00}},
	...
	{0x6F, 1, {0x45}},       //reg vcl + pumping ratio VGH=4x VGL=-2x
	{0x8D, 1, {0x14}},       //-10V  
	{0x87, 1, {0xBA}},       //ESD   
	{0x26, 1, {0x76}},  
	{0xB2, 1, {0xD1}},   
	...
	{0x39, 1, {0x00}},  
	{0x7A, 1, {0x10}},       //0F
	//{0x00, 1, {0x00}},      //3lane,0x4LANE去掉这个代码
	...
	{0x54, 1, {0x00}},		//VCOM2
	{0x55, 1, {0x59}},		//VCOM2
	{0x50, 1, {0xAE}},		//VREG1OUT=4.8V  BA
	{0x51, 1, {0xA9}},		//VREG2OUT=-4.8V AF
	{0x60, 1, {0x1F}},	        //SDT=2.5
	//{0x61, 1, {0x01}},
...
static void lcm_get_params(struct LCM_PARAMS *params)
{
    ...
    params->dsi.horizontal_frontporch                           = 14; //60; 
    params->dsi.horizontal_active_pixel                         = FRAME_WIDTH;

    params->dsi.PLL_CLOCK = 205;//235
}
...
struct LCM_DRIVER gs960_bns_ili9881c_boe_wxga_ips_101_lcm_drv = {
	.name = "gs960_bns_ili9881c_boe_wxga_ips_101",
