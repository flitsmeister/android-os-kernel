...
static void lcm_get_params(struct LCM_PARAMS *params)
{
   memset(params, 0, sizeof(struct LCM_PARAMS));
    ...
    params->dsi.horizontal_sync_active                          = 1; //16; // 10; //5;//6;
    params->dsi.horizontal_backporch                            = 60; //48; //60; //60; //80;
...
struct LCM_DRIVER pf717_zjgd_hx8279d_boe_wuxga_ips_101_lcm_drv =
{
    .name			= "pf717_zjgd_hx8279d_boe_wuxga_ips_101",
