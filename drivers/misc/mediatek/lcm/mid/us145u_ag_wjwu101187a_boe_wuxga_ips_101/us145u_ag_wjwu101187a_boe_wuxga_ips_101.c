...
static void lcm_get_params(struct LCM_PARAMS *params)
{
	...
	params->dsi.vertical_backporch					= 16;//16;  //4
	params->dsi.vertical_frontporch					= 20;//9;  //8
	params->dsi.vertical_active_line				= FRAME_HEIGHT; 

	params->dsi.horizontal_sync_active				= 10;//18;  //14
	params->dsi.horizontal_backporch				= 40;//92;  //140
	params->dsi.horizontal_frontporch				= 80;//92; //16
	params->dsi.horizontal_active_pixel				= FRAME_WIDTH;

	params->dsi.PLL_CLOCK  = 440; //275;
}
...
struct LCM_DRIVER us145u_ag_wjwu101187a_boe_wuxga_ips_101_lcm_drv =
{
    .name			= "us145u_ag_wjwu101187a_boe_wuxga_ips_101",
