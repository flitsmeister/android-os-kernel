...
static void lcd_vdd_3v3_en(unsigned char enabled)
{
    if (enabled)
    {
...
static void lcm_get_params(struct LCM_PARAMS *params)
{
    ...
    params->dsi.vertical_backporch                              = 28; //10; //16;
...
static __attribute__((unused)) struct LCM_setting_table init_setting[] = {
	...
	{0x44, 1, {0x10}},
	{0x45, 1, {0x28}},
		// 1, {Generic_Short_Write_1P(0x4A,0x35}},
	{0x4B, 1, {0x04}},
	{0x55, 1, {0x02}},
	{0x56, 1, {0x01}},
	{0x57, 1, {0xA9}},
...
struct LCM_DRIVER us868_jf_jd9365da_wxga_ips_8_lcm_drv =
{
    .name			= "us868_jf_jd9365da_wxga_ips_8",
