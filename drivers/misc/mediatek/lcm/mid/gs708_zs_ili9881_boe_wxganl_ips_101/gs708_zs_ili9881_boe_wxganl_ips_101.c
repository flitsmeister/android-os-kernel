...
static __attribute__((unused)) struct LCM_setting_table init_setting[] = {
	...
	{0x6E, 1, {0x30}},     //VGH 16V   vgh Clamp level
	{0x6F, 1, {0x33}},    //Pump ratio VGH=VSPX3 VGL=VSNX2
	{0x8D, 1, {0x1F}},   // VGL clamp -12.03    LCD SPEC -12
	
	{0x3A, 1, {0x24}},     //power saving
	{0x35, 1, {0x1F}},    // Source OP drive time
	...
	{0x22, 1, {0x0A}},
	{0x31, 1, {0x09}},   //zig-zag type1 09
	{0x40, 1, {0x33}},   //for ext_cpck_sel
	{0x42, 1, {0x44}},   //VGHL-CLK-SELA   VGHL-CLK-SELB
	{0x53, 1, {0x2E}},  // FW VCOM//30
	{0x55, 1, {0x88}},  // BW VCOM
	{0x50, 1, {0x95}},    //Source 4.5, 1, { 95    AE 4.8
	{0x51, 1, {0x95}},    //Source -4.5 95    AE -4.8
	{0x60, 1, {0x43}},
...
struct LCM_DRIVER gs708_zs_ili9881_boe_wxganl_ips_101_lcm_drv = {
	.name = "gs708_zs_ili9881_boe_wxganl_ips_101",
