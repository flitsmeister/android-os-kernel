...
static void lcm_get_params(struct LCM_PARAMS *params)
{
    ...
    params->dsi.horizontal_sync_active                          = 18; //16; // 10; //5;//6;
    params->dsi.horizontal_backporch                            = 18; //48; //60; //60; //80;
    params->dsi.horizontal_frontporch                           = 18; //16; //60; 
...
struct LCM_DRIVER gs717_sat_jd9365da_inx_wxga_ips_101_lcm_drv = {
	.name = "gs717_sat_jd9365da_inx_wxga_ips_101",
