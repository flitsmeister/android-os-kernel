...
{
	printk("chenxinfeng lcd_power_en\n");
    if (enabled)
    {
...
static void lcm_get_params(struct LCM_PARAMS *params)
{
	   memset(params, 0, sizeof(struct LCM_PARAMS));
		...
		params->dsi.PLL_CLOCK = 155;//400
}


static void lcm_init(void)
{
	printk("chenxinfeng lcm_init\n");
	avdd_enable(1);
	lcd_power_en(1);
	MDELAY(100);
	lcd_reset(1);
...
struct LCM_DRIVER us828_tf_ek79007_boe_wvxga_ips_7_lcm_drv = 
{
    .name			= "us828_tf_ek79007_boe_wvxga_ips_7",
