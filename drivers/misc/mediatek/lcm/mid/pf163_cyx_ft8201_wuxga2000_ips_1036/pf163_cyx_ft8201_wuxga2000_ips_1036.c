...
static void lcm_get_params(struct LCM_PARAMS *params)
{
    ...
    params->dsi.vertical_frontporch             = 179;
...
struct LCM_DRIVER pf163_cyx_ft8201_wuxga2000_ips_1036_lcm_drv =
{
    .name            = "pf163_cyx_ft8201_wuxga2000_ips_1036",
