...
static void lcm_get_params(struct LCM_PARAMS *params)
{
    ...
    params->dsi.horizontal_backporch                            = 70; //60; //60; //80;
...
struct LCM_DRIVER us716u_fx_ili9881c_k080im2ayl815r_auo_wxga_8_lcm_drv = 
{
    .name			= "us716u_fx_ili9881c_k080im2ayl815r_auo_wxga_8",
