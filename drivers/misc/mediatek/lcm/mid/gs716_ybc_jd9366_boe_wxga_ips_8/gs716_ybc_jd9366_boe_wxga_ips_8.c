...
//    {0x17, 1, {0x00} },
    ...
    {0x19, 1, {0x01} },
   // {0x1A, 1, {0x00} },
    {0x1B, 1, {0xB2} },  //VGMN=-4.5V
    {0x1C, 1, {0x01} },
    {0x1F, 1, {0x7E} },     //VGH_R  = 15V                       
    {0x20, 1, {0x28} },     //VGL_R  = -11V                      
    {0x21, 1, {0x28} },     //VGL_R2 = -11V                      
    {0x22, 1, {0x0E} },     //PA[6]=0, PA[5]=0, PA[4]=0, PA[0]=0 
    {0x24, 1, {0xC8} }, 
   // {0x35, 1, {0x05} }, //26
    {0x37, 1, {0x29} }, //SS=1,BGR=1
    {0x38, 1, {0x05} }, //JDT=100 column inversion
...
struct LCM_DRIVER gs716_ybc_jd9366_boe_wxga_ips_8_lcm_drv = {
	.name = "gs716_ybc_jd9366_boe_wxga_ips_8",
