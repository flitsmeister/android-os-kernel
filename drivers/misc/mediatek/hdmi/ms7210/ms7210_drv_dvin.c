...
BOOL ms7210drv_dvin_timing_config(DVIN_CONFIG_T *t_dvin_config, VIDEOTIMING_T *t_output_timing, UINT8 *u8_rpt)
{
    ...
    {
        b_need_x2_clk = TRUE;
        t_output_timing->u16_htotal /= *u8_rpt;
        t_output_timing->u16_hsyncwidth /= *u8_rpt;
        t_output_timing->u16_hoffset /= *u8_rpt;
        t_output_timing->u16_hactive /= *u8_rpt;
        t_output_timing->u16_pixclk /= *u8_rpt;
        *u8_rpt = 0;
    }
    ...
    if (*u8_rpt)
    {
        st_output_timing.u16_htotal /= *u8_rpt;
        st_output_timing.u16_hsyncwidth /= *u8_rpt;
        st_output_timing.u16_hoffset /= *u8_rpt;
        st_output_timing.u16_hactive /= *u8_rpt;
        st_output_timing.u16_pixclk /= *u8_rpt;
        *u8_rpt = 1;
        b_need_x2_clk = TRUE;
    }
