...
#define AP_AUXADC_DISO_VDC_CHANNEL 2
#define AP_AUXADC_DISO_VUSB_CHANNEL 3


#define R_DISO_DC_PULL_UP 24000
#define R_DISO_DC_PULL_DOWN 1000
#define R_DISO_VBUS_PULL_UP 5100
#define R_DISO_VBUS_PULL_DOWN 1000
#define VDC_MIN_VOLTAGE  4240000 /*FPF3040 min value is 4000, set larger for PMIC detect*/
#define VDC_MAX_VOLTAGE 24000000
#define VBUS_MIN_VOLTAGE  4240000 /*FPF3040 min value is 4000, set larger for PMIC detect*/
