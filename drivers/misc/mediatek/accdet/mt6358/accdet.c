...
#elif CONFIG_MID_TYPEC_MT6370CC_ACCDET
static struct work_struct eint_work;
static struct workqueue_struct *eint_workqueue;
#endif
...
#ifdef CONFIG_ACCDET_EINT
#ifndef CONFIG_MID_TYPEC_MT6370CC_ACCDET
...
#ifdef CONFIG_SND_SOC_AW8737_SUPPORT
		pmic_write(0x228c, 0x00);
		pmic_write(0x228e, 0x01);
		pmic_write(0x2388, 0x5481);
		pmic_write(0x238a, 0x5481);
		headset_status = 1;
#endif
...
#ifdef CONFIG_SND_SOC_AW8737_SUPPORT			
		pmic_write(0x228c, 0x80);
		pmic_write(0x228e, 0x03);
		pmic_write(0x2388, 0x400);
		pmic_write(0x238a, 0x400);	
		headset_status = 0;
#endif		
		disable_accdet();
		headset_plug_out();
...
#ifdef CONFIG_MID_TYPEC_MT6370CC_ACCDET
void mid_hp_detect(int state)
{
       int ret = 0;
       ...
       printk("accdet %s(), cur_eint_state=%d\n", __func__, cur_eint_state);
       ret = queue_work(eint_workqueue, &eint_work);
       return;
}
EXPORT_SYMBOL(mid_hp_detect);
#endif
