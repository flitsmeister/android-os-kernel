...
#ifdef CONFIG_BIRD_TWO_FAKE_DUAL_CAM_SUPPORT
	#define CONFIG_BIRD_FAKE_DUAL_CAM_SUPPORT_MAIN2_FAKE
#endif

#ifdef CONFIG_BIRD_FAKE_DUAL_CAM_SUPPORT_MAIN2_FAKE
#pragma message("CONFIG_BIRD_FAKE_DUAL_CAM_SUPPORT_MAIN2_FAKE is defined!!!\n")
extern kal_uint32 mainsensor_id;
extern int main2_id_gc0310;
extern int main2_id_sp0a08;
#endif
static DEFINE_SPINLOCK(imgsensor_drv_lock);

int ov13853_chip_ver = OV13853_R2A;
//for test 
int m_bpc_select_ov13853=0;
//sensor otp
...
}else if(m_bpc_select_ov13853 == 2)
{
...
else if(m_bpc_select_ov13853 == 3)
{
...
int capture_first_flag_ov13853 = 0;
int pre_currefps_ov13853 = 0;
static void capture_setting(kal_uint16 currefps)
{
    LOG_INF("E! currefps:%d\n",currefps);	
if (pre_currefps_ov13853 != currefps)
{
	capture_first_flag_ov13853 = 0;
	pre_currefps_ov13853 = currefps;
}
else
{
	capture_first_flag_ov13853 = 1;
}
if (capture_first_flag_ov13853 == 0)
{
...
#ifdef CONFIG_BIRD_FAKE_DUAL_CAM_SUPPORT_MAIN2_FAKE
    main2_id_gc0310 = return_sensor_id_gc0310();
    main2_id_sp0a08 = return_sensor_id_sp0a08();
    LOG_INF("[fzx main2_fake_return_sensor_id]Read main2_fake sensor id, gc0310 write id: 0x%x, gc0310_id: 0x%x\n", GC0310_WRITE_ID,main2_id_gc0310);
    LOG_INF("[fzx main2_fake_return_sensor_id]Read main2_fake sensor id, sp0a08 write id: 0x%x, sp0a08_id: 0x%x\n", SP0A08_WRITE_ID,main2_id_sp0a08);
#endif
...
#ifdef CONFIG_BIRD_FAKE_DUAL_CAM_SUPPORT_MAIN2_FAKE
	main2_id_gc0310 = return_sensor_id_gc0310();
	if(main2_id_gc0310 == 0xa310)
	{
		sensor_init_gc0310();
		LOG_INF("main2 gc0310 init \n");
	}
	else
		LOG_INF("main2 read gc0310 id failed\n");
	main2_id_sp0a08 = return_sensor_id_sp0a08();
	if(main2_id_sp0a08 == 0xa2)
	{
		sensor_init_sp0a08();
		LOG_INF("main2 sp0a08 init \n");
	}
	else
		LOG_INF("main2 read sp0a08 id failed\n");
#endif 
    spin_lock(&imgsensor_drv_lock);
...
{
	  LOG_INF("cam [Kernel/ov13853mipiraw_Sensor]: %s %d  \n", __func__,__LINE__);
