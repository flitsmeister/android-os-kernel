...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
	...
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
	  ...
	  printk("8858  cam : i2c write id: 0x%x, *sensor_id: 0x%x, version = %d(0=r2a,1=r1a) imgsensor_info.sensor_id : 0x%x\n",
			imgsensor.i2c_write_id, *sensor_id, ov8858version,imgsensor_info.sensor_id);
		...
		printk("8858  cam : Read sensor id fail, id: 0x%x,sensor_id=0x%x\n",
	...
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		...
		do {
		  ...
		  ((read_cmos_sensor(0x300B) << 8) | read_cmos_sensor(0x300C));
			...
			if (sensor_id == imgsensor_info.sensor_id) {
				printk("8858  cam : i2c write id: 0x%x, sensor id: 0x%x\n",
					imgsensor.i2c_write_id, sensor_id);
				break;
			}
			printk("8858  cam : Read sensor id fail, id: 0x%x,sensor_id =0x%x\n",
