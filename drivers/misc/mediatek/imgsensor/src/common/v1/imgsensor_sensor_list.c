 ...
 */
#if defined(CONFIG_MACH_MT6739)	//mid cam for mt8765
struct IMGSENSOR_INIT_FUNC_LIST kdSensorList[MAX_NUM_OF_SUPPORT_SENSOR] = {
	
#if defined(GC05A2_MIPI_RAW)
	{GC05A2_SENSOR_ID, SENSOR_DRVNAME_GC05A2_MIPI_RAW, GC05A2_MIPI_RAW_SensorInit},
#endif
	...
	{GC02M2MIPI_SENSOR_ID, SENSOR_DRVNAME_GC02M2_MIPI_RAW, GC02M2_MIPI_RAW_SensorInit},
#endif	
...
#elif defined(CONFIG_MACH_MT6761) //mid cam for mt8766
struct IMGSENSOR_INIT_FUNC_LIST kdSensorList[MAX_NUM_OF_SUPPORT_SENSOR] = {
	...
	{T4K86_SENSOR_ID, SENSOR_DRVNAME_T4K86_MIPI_RAW, T4K86_MIPI_RAW_SensorInit},
#endif
	...
	{GC5035SUBMIPI_SENSOR_ID, SENSOR_DRVNAME_GC5035SUB_MIPI_RAW, GC5035SUB_MIPI_RAW_SensorInit},
#endif
	...
	{GC02M1_SENSOR_ID, SENSOR_DRVNAME_GC02M1_MIPI_RAW, GC02M1_MIPI_RAW_SensorInit},
 	...
 	{BF2553L_SENSOR_ID, SENSOR_DRVNAME_BF2553L_MIPI_RAW, BF2553LMIPI_RAW_SensorInit},
#endif
	...
	{GC05A2SUB_SENSOR_ID, SENSOR_DRVNAME_GC05A2SUB_MIPI_RAW, GC05A2SUB_MIPI_RAW_SensorInit},
#endif
#if defined(SC201CS_MIPI_RAW)
	{SC201CSMIPI_SENSOR_ID, SENSOR_DRVNAME_SC201CSMIPI_RAW, SC201CSMIPI_RAW_SensorInit},
#endif
	/*  ADD sensor driver before this line */
	{0, {0}, NULL}, /* end of list */
};
...
#elif defined(CONFIG_MACH_MT6765)	//mid cam for mt8768
struct IMGSENSOR_INIT_FUNC_LIST kdSensorList[MAX_NUM_OF_SUPPORT_SENSOR] = {
#if defined(S5K3L8_MIPI_RAW)
	{S5K3L8_SENSOR_ID,SENSOR_DRVNAME_S5K3L8_MIPI_RAW,S5K3L8_MIPI_RAW_SensorInit},
#endif
    ...
    {SC500CSSUBMIPI_SENSOR_ID, SENSOR_DRVNAME_SC500CSSUB_MIPI_RAW,SC500CSSUBMIPI_RAW_SensorInit},
#endif
...
#elif defined(CONFIG_MACH_MT6768)	//mid cam for mt8786
struct IMGSENSOR_INIT_FUNC_LIST kdSensorList[MAX_NUM_OF_SUPPORT_SENSOR] = {
#if defined(S5K3L8_MIPI_RAW)
	{S5K3L8_SENSOR_ID,SENSOR_DRVNAME_S5K3L8_MIPI_RAW,S5K3L8_MIPI_RAW_SensorInit},
#endif
	...
	{OV8858SUB_SENSOR_ID,SENSOR_DRVNAME_OV8858SUB_MIPI_RAW,OV8858SUB_MIPI_RAW_SensorInit},
#endif
