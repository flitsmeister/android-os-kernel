 ...
 *
 ****************************************************************************/
#ifndef __SC201CSMIPI_SENSOR_H__
#define __SC201CSMIPI_SENSOR_H__

/* SENSOR MIRROR FLIP INFO */
#define SC201CS_MIRROR_FLIP_ENABLE         0
#if SC201CS_MIRROR_FLIP_ENABLE
#define SC201CS_MIRROR                     0x66 //mirror&flip
#else
#define SC201CS_MIRROR                     0x00 //normal
#endif

/* SENSOR PRIVATE INFO FOR GAIN SETTING */
#define SC201CS_SENSOR_GAIN_BASE             0x400
#define SC201CS_SENSOR_GAIN_MAX              (3175 * SC201CS_SENSOR_GAIN_BASE / 100)
#define SC201CS_SENSOR_GAIN_MAX_VALID_INDEX  5
#define SC201CS_SENSOR_GAIN_MAP_SIZE         5
#define SC201CS_SENSOR_DGAIN_BASE            0x400
