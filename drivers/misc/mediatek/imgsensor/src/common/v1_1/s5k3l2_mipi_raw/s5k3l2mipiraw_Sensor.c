...
static struct imgsensor_info_struct imgsensor_info = {
    ...
    .sensor_output_dataformat = SENSOR_OUTPUT_FORMAT_RAW_Gb,//case 1: SENSOR_OUTPUT_FORMAT_RAW_Gr,-->IMAGE_NORMAL	case 2:SENSOR_OUTPUT_FORMAT_RAW_Gb-->IMAGE_HV_MIRROR
...
static void check_output_stream_on(void)
{
	...
	for(read_count = 0; read_count <= 4; read_count++)
	{
		...
		if(read_count == 4)
			pr_debug("[error][0x0005, 0xff]sensor not output\n");
	}
}
