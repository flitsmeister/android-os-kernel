...
static kal_uint32 open(void)
{
	...
	{
		sensor_init_gc0310();
		printk("main2 gc0310 init \n");
	}
	else
		printk("main2 read gc0310 id failed\n");
	main2_id_sp0a08 = return_sensor_id_sp0a08();
	if(main2_id_sp0a08 == 0xa2)
	{
		sensor_init_sp0a08();
		printk("main2 sp0a08 init \n");
	}
	else
		printk("main2 read sp0a08 id failed\n");
#endif 
    spin_lock(&imgsensor_drv_lock);
...
{
	  printk("cam [Kernel/ov13853mipiraw_Sensor]: %s %d  \n", __func__,__LINE__);
