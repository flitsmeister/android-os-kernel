...
static DEFINE_SPINLOCK(imgsensor_drv_lock);
 ...
 extern  BYTE sunwin_get_otp_lens_id(void);
...
static imgsensor_info_struct imgsensor_info = {
    ...
    .checksum_value = 0x4aca93c1,//0x1887021//0x4ff3b7e6,
        ...
        do {
            *sensor_id = return_sensor_id();
            if (*sensor_id == imgsensor_info.sensor_id) {
                printk("[imx135]i2c write id: 0x%x, sensor id: 0x%x\n", imgsensor.i2c_write_id,*sensor_id);
                return ERROR_NONE;
            }
            printk("[imx135]Read sensor id fail, id: 0x%x\n", imgsensor.i2c_write_id,*sensor_id);
            retry--;
        } while(retry > 0);
        i++;
        retry = 2;
