 ...
 * Filename:
 * ---------
 *	 OV8858SUBmipiraw_sensor.c
 *
 * Project:
 * --------
 *	 ALPS MT6580 2lane ov8858subr2a
 *
 * Description:
 * ------------
...
#include "ov8858submipiraw_Sensor.h"
...
enum OV8858SUB_VERSION {
	OV8858SUBR2A,
	OV8858SUBR1A
};

enum OV8858SUB_VERSION ov8858subversion = OV8858SUBR2A;
enum boot_mode_t bm_sub;
...
static struct imgsensor_info_struct imgsensor_info = {
	...
	.sensor_id = OV8858SUB_SENSOR_ID,

	.checksum_value = 0x18ba99f0, /* checksum value for Camera Auto Test */
...
enum SENSOR_DPCM_TYPE_ENUM imgsensor_dpcm_info_ov8858sub[10] = {
	COMP8_NONE,
	COMP8_NONE,
	COMP8_NONE,
	COMP8_NONE,
...
#endif
static kal_uint16 ov8858sub_table_write_cmos_sensor(
...
kal_uint16 addr_data_pair_init_ov8858sub[] = {
	0x100, 0x00,
	0x302, 0x1e,
	0x303, 0x00,
	0x304, 0x03,
...
static void sensor_init(void)
{
	...
	/* OV8858SUB R2A setting */
	/* 3.1 Initialization (Global Setting) */
	/* XVCLK=24Mhz, SCLK=72Mhz, MIPI 720Mbps, DACCLK=180Mhz */
	write_cmos_sensor(0x103, 0x01);
	mdelay(5);
#if 1				/* MULTI_WRITE */
	ov8858sub_table_write_cmos_sensor(addr_data_pair_init_ov8858sub,
		    sizeof(addr_data_pair_init_ov8858sub) / sizeof(kal_uint16));
	...
	if (bm_sub == FACTORY_BOOT || bm_sub == ATE_FACTORY_BOOT)
		write_cmos_sensor(0x3031, 0x0a);
	else
...
kal_uint16 addr_data_pair_preview_ov8858sub[] = {
	0x0302, 0x1e,
	0x030e, 0x00,
	0x0312, 0x01,
	0x3015, 0x01,
...
/* ;XVCLK=24Mhz, SCLK=72Mhz, MIPI 720Mbps, DACCLK=180Mhz, Tline = 8.925926us */
	/* mdelay(5); */
#if 1				/* MULTI_WRITE */
	ov8858sub_table_write_cmos_sensor(addr_data_pair_preview_ov8858sub,
		    sizeof(addr_data_pair_preview_ov8858sub) / sizeof(kal_uint16));
...
kal_uint16 addr_data_pair_capture_30fps_ov8858sub[] = {
	0x0302, 0x2e,
	0x030e, 0x00,
	0x0312, 0x01,
	0x3015, 0x01,
...
kal_uint16 addr_data_pair_capture_15fps_ov8858sub[] = {
	0x0302, 0x1e,
	0x030e, 0x02,
	0x0312, 0x03,
	0x3015, 0x00,
...
kal_uint16 addr_data_pair_capture_24fps_ov8858sub[] = {
	0x0302, 0x2e,
	0x030e, 0x00,
	0x0312, 0x01,
	0x3015, 0x01,
...
static void capture_setting(kal_uint16 currefps)
{
	...
	if (currefps == 300) {
		ov8858sub_table_write_cmos_sensor(
		addr_data_pair_capture_30fps_ov8858sub,
	    sizeof(addr_data_pair_capture_30fps_ov8858sub) / sizeof(kal_uint16));
	}
	if (currefps == 150) {
		ov8858sub_table_write_cmos_sensor(
		addr_data_pair_capture_15fps_ov8858sub,
	    sizeof(addr_data_pair_capture_15fps_ov8858sub) / sizeof(kal_uint16));
	}
	if (currefps == 240) {
		ov8858sub_table_write_cmos_sensor(
			addr_data_pair_capture_24fps_ov8858sub,
	    sizeof(addr_data_pair_capture_24fps_ov8858sub) / sizeof(kal_uint16));
		  ...
		  ((read_cmos_sensor(0x300B) << 8) | read_cmos_sensor(0x300C)) + 1;
			if (*sensor_id == imgsensor_info.sensor_id) {
				if ((read_cmos_sensor(0x302A)) == 0XB2) {
					ov8858subversion = OV8858SUBR2A;
					printk("[ov8858sub]read sucess i2c write id: 0x%x, id: 0x%x, version = %d(0=r2a,1=r1a)\n",
				imgsensor.i2c_write_id, *sensor_id, ov8858subversion);
				return ERROR_NONE;
				} else if ((read_cmos_sensor(0x302A)) == 0XB1) {
					printk("[ov8858sub] read sensor id failed! cam i2c write id: 0x%x\n",imgsensor.i2c_write_id);
	...
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		...
		do {
		  ...
		  ((read_cmos_sensor(0x300B) << 8) | read_cmos_sensor(0x300C)) + 1;
			...
			if (sensor_id == imgsensor_info.sensor_id) {
				printk(" cam: i2c write id: 0x%x, sensor id: 0x%x\n",
					imgsensor.i2c_write_id, sensor_id);
				break;
			}
			printk(
			    "cam:Read sensor id fail, id: 0x%x,sensor_id =0x%x\n",
			    imgsensor.i2c_write_id, sensor_id);
			   ...
			   MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	...
	case MSDK_SCENARIO_ID_CAMERA_PREVIEW:
		...
		sensor_info->DPCM_INFO = imgsensor_dpcm_info_ov8858sub[0];
	...
	case MSDK_SCENARIO_ID_CAMERA_CAPTURE_JPEG:
		...
		sensor_info->DPCM_INFO = imgsensor_dpcm_info_ov8858sub[1];
		sensor_info->MIPIDataLowPwr2HighSpeedSettleDelayCount =
	...
	case MSDK_SCENARIO_ID_VIDEO_PREVIEW:
		...
		sensor_info->DPCM_INFO = imgsensor_dpcm_info_ov8858sub[2];
		sensor_info->MIPIDataLowPwr2HighSpeedSettleDelayCount =
	...
	case MSDK_SCENARIO_ID_HIGH_SPEED_VIDEO:
		...
		sensor_info->DPCM_INFO = imgsensor_dpcm_info_ov8858sub[3];
		sensor_info->MIPIDataLowPwr2HighSpeedSettleDelayCount =
	...
	case MSDK_SCENARIO_ID_SLIM_VIDEO:
		...
		sensor_info->DPCM_INFO = imgsensor_dpcm_info_ov8858sub[4];
		sensor_info->MIPIDataLowPwr2HighSpeedSettleDelayCount =
...
UINT32 OV8858SUB_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
