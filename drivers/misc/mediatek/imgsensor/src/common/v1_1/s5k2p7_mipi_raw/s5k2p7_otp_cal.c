...
int S5K2P7_read_eeprom(kal_uint16 addr, BYTE* data, kal_uint32 size )
{
	int i = 0;
	BYTE* data1 = NULL;
	int offset = addr;
	...
	size = DATA_SIZE;
	selective_read_eeprom(0x0000, &data1[0]);
	printk("add by zx:S5K2P7_read_eeprom flag = %c\n",data1[0]);
	for(i = 0; i < size; i++)
	{
