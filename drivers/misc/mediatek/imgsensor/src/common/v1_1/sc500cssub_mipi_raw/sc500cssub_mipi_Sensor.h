 ...
 *
 ****************************************************************************/
#ifndef __SC500CSSUB_MIPI_SENSOR_H__
#define __SC500CSSUB_MIPI_SENSOR_H__

/* SENSOR MIRROR FLIP INFO */
#define SC500CSSUB_MIRROR_FLIP_ENABLE         0
#if SC500CSSUB_MIRROR_FLIP_ENABLE
#define SC500CSSUB_MIRROR                     0x66 //mirror&flip
#else
#define SC500CSSUB_MIRROR                     0x00 //normal
#endif

/* SENSOR PRIVATE INFO FOR GAIN SETTING */
#define SC500CSSUB_SENSOR_GAIN_BASE             0x400
#define SC500CSSUB_SENSOR_GAIN_MAX              (1575 * SC500CSSUB_SENSOR_GAIN_BASE / 100)
#define SC500CSSUB_SENSOR_GAIN_MAX_VALID_INDEX  4
#define SC500CSSUB_SENSOR_GAIN_MAP_SIZE         17
#define SC500CSSUB_SENSOR_DGAIN_BASE            0x400
