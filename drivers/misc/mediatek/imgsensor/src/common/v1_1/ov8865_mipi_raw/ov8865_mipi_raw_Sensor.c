...
extern int sunvov_get_curr_camera_index(void);
/*************************************************************************
* FUNCTION
*	get_imgsensor_id
*
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id) 
{
	...
	printk("[chenp]i2c write id: 0x%x, sensor id: 0x%x\n", imgsensor.i2c_write_id,*sensor_id);	  
				return ERROR_NONE;
			}	
			printk("[chenp]Read sensor id fail, write id: 0x%x, id: 0x%x\n", imgsensor.i2c_write_id,*sensor_id);
			retry--;
		} while(retry > 0);
