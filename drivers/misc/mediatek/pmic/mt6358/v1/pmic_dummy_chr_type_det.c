...
#if defined(CONFIG_CHARGER_SGM41516D)||defined (CONFIG_CHARGER_SC8989X)||defined (CONFIG_CHARGER_SGM415XX)||defined (CONFIG_CHARGER_ETA6963)||defined (CONFIG_CHARGER_SGM415XXSUB)
