...
#ifndef _eta696x_SW_H_
#define _eta696x_SW_H_

#define eta696x_CON0      0x00
#define eta696x_CON1      0x01
#define eta696x_CON2      0x02
#define eta696x_CON3      0x03
#define eta696x_CON4      0x04
#define eta696x_CON5      0x05
#define eta696x_CON6      0x06
#define eta696x_CON7      0x07
#define eta696x_CON8      0x08
#define eta696x_CON9      0x09
#define eta696x_CON10      0x0A
#define	eta696x_CON11		0x0B
#define eta696x_REG_NUM 12

#define ETA696x_VBUS_STAT_MASK      0xE0
#define ETA696x_VBUS_STAT_SHIFT     5
#define ETA696x_VBUS_TYPE_NONE		0
#define ETA696x_VBUS_TYPE_SDP		1
#define ETA696x_VBUS_TYPE_CDP		2
#define ETA696x_VBUS_TYPE_DCP		3
#define ETA696x_VBUS_TYPE_HVDCP		4
#define ETA696x_VBUS_TYPE_UNKNOWN	5
#define ETA696x_VBUS_TYPE_NON_STD	6
#define ETA696x_VBUS_TYPE_OTG		7
...
#define eta696x_CHG_STATUS_READY    1
#define eta696x_CHG_STATUS_PROGRESS 2
#define eta696x_CHG_STATUS_DONE     3
#define eta696x_CHG_STATUS_NOT_CHARGING    0
/**********************************************************
 *
 *   [Extern Function]
 *
 *********************************************************/
//CON0----------------------------------------------------
extern void eta696x_set_en_hiz(unsigned int val);
extern void eta696x_set_vindpm(unsigned int val);
extern void eta696x_set_iinlim(unsigned int val);
//CON1----------------------------------------------------
extern void eta696x_set_reg_rst(unsigned int val);
extern void eta696x_set_pfm(unsigned int val);
extern void eta696x_set_wdt_rst(unsigned int val);
extern void eta696x_set_chg_config(unsigned int val);
extern void eta696x_set_otg_config(unsigned int val);
extern void eta696x_set_sys_min(unsigned int val);
extern void eta696x_set_boost_lim(unsigned int val);
//CON2----------------------------------------------------
extern void eta696x_set_ichg(unsigned int val);
extern void eta696x_set_rdson(unsigned int val);
extern void eta696x_set_force_20pct(unsigned int val);
//CON3----------------------------------------------------
extern void eta696x_set_iprechg(unsigned int val);
extern void eta696x_set_iterm(unsigned int val);
//CON4----------------------------------------------------
extern void eta696x_set_vreg(unsigned int val);
extern void eta696x_set_batlowv(unsigned int val);
extern void eta696x_set_vrechg(unsigned int val);
extern void eta696x_set_topoff_timer(unsigned int val);
//CON5----------------------------------------------------
extern void eta696x_set_en_term(unsigned int val);
extern void eta696x_set_term_stat(unsigned int val);
extern void eta696x_set_watchdog(unsigned int val);
extern void eta696x_set_en_timer(unsigned int val);
extern void eta696x_set_chg_timer(unsigned int val);
//CON6----------------------------------------------------
extern void eta696x_set_treg(unsigned int val);
//CON7----------------------------------------------------
extern void eta696x_set_tmr2x_en(unsigned int val);
extern void eta696x_set_batfet_disable(unsigned int val);
extern void eta696x_set_int_mask(unsigned int val);
//CON8----------------------------------------------------
extern unsigned int eta696x_get_system_status(void);
extern unsigned int eta696x_get_vbus_stat(void);
extern unsigned int eta696x_get_chrg_stat(void);
extern unsigned int eta696x_get_vsys_stat(void);
//---------------------------------------------------------

extern unsigned int eta696x_reg_config_interface(unsigned char RegNum,
		unsigned char val);

extern unsigned int eta696x_read_interface(unsigned char RegNum,
		unsigned char *val, unsigned char MASK, unsigned char SHIFT);
extern unsigned int eta696x_config_interface(unsigned char RegNum,
		unsigned char val, unsigned char MASK, unsigned char SHIFT);
#endif // _eta696x_SW_H_
