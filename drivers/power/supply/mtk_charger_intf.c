...
#define PMIC_RG_VLDO28_OP_EN_ADDR      0x1b34
#define PMIC_RG_VLDO28_OP_EN_SHIFT     0
#define PMIC_RG_VLDO28_OP_EN_MASK      3
int vldo28_op_lp(void)
{
	...
	pmic_set_register_value1(regmap,
		PMIC_RG_VLDO28_OP_EN_ADDR,
		PMIC_RG_VLDO28_OP_EN_MASK,
		PMIC_RG_VLDO28_OP_EN_SHIFT,
		0x03);
