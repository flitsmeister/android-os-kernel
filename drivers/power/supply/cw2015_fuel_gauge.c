...
static unsigned char config_info[SIZE_BATINFO] = {
    0x15, 0x7E, 0x5F, 0x58, 0x56, 0x4A, 0x70, 0x3F,
    0x48, 0x4B, 0x48, 0x47, 0x49, 0x40, 0x33, 0x2A,
    0x24, 0x1F, 0x19, 0x17, 0x20, 0x2F, 0x41, 0x4B,
    0x23, 0x22, 0x0C, 0xCD, 0x36, 0x56, 0x51, 0x60,
    0x6A, 0x65, 0x62, 0x65, 0x3F, 0x1C, 0x68, 0x41,
    0x0A, 0x45, 0x13, 0x3D, 0x73, 0x99, 0xAB, 0x20,
    0x47, 0x7E, 0x98, 0xA5, 0x80, 0x67, 0x92, 0xCB,
    0x2F, 0x00, 0x64, 0xA5, 0xB5, 0x04, 0x92, 0x11
};
...
EXPORT_SYMBOL_GPL(g_cw2015_capacity);
int g_cw2015_vol = 0;
EXPORT_SYMBOL_GPL(g_cw2015_vol);
...
int cw_update_config_info(struct cw_battery *cw_bat)
{
    ...
    for (i = 0; i < SIZE_BATINFO; i++) {
        cw_printk("[REG_BATINFO] test config_info = 0x%x\n",config_info[0]);
...
static int cw_init(struct cw_battery *cw_bat)
{
    ...
    if (!(reg_val & CONFIG_UPDATE_FLG)) {
        ...
        for(i = 0; i < SIZE_BATINFO; i++) {
            ...
            cw_printk(KERN_INFO "reg[%02X] = %02X\n", i, reg_val);
