...
#ifndef _sgm41513_SW_H_
#define _sgm41513_SW_H_
...
#define sgm41513_CON10      0x0A
#define	sgm41513_CON11		0x0B
#define sgm41513_REG_NUM 0xF
 ...
 *********************************************************/
//CON0----------------------------------------------------
extern void sgm41513_set_en_hiz(unsigned int val);
extern void sgm41513_set_vindpm(unsigned int val);
extern void sgm41513_set_iinlim(unsigned int val);
//CON1----------------------------------------------------
extern void sgm41513_set_reg_rst(unsigned int val);
extern void sgm41513_set_pfm(unsigned int val);
extern void sgm41513_set_wdt_rst(unsigned int val);
extern void sgm41513_set_chg_config(unsigned int val);
extern void sgm41513_set_otg_config(unsigned int val);
extern void sgm41513_set_sys_min(unsigned int val);
extern void sgm41513_set_boost_lim(unsigned int val);
//CON2----------------------------------------------------
extern void sgm41513_set_ichg(unsigned int val);
extern void sgm41513_set_rdson(unsigned int val);
extern void sgm41513_set_force_20pct(unsigned int val);
//CON3----------------------------------------------------
extern void sgm41513_set_iprechg(unsigned int val);
extern void sgm41513_set_iterm(unsigned int val);
//CON4----------------------------------------------------
extern void sgm41513_set_vreg(unsigned int val);
extern void sgm41513_set_batlowv(unsigned int val);
extern void sgm41513_set_vrechg(unsigned int val);
extern void sgm41513_set_topoff_timer(unsigned int val);
//CON5----------------------------------------------------
extern void sgm41513_set_en_term(unsigned int val);
extern void sgm41513_set_term_stat(unsigned int val);
extern void sgm41513_set_watchdog(unsigned int val);
extern void sgm41513_set_en_timer(unsigned int val);
extern void sgm41513_set_chg_timer(unsigned int val);
//CON6----------------------------------------------------
extern void sgm41513_set_treg(unsigned int val);
//CON7----------------------------------------------------
extern void sgm41513_set_tmr2x_en(unsigned int val);
extern void sgm41513_set_batfet_disable(unsigned int val);
extern void sgm41513_set_int_mask(unsigned int val);
//CON8----------------------------------------------------
extern unsigned int sgm41513_get_system_status(void);
extern unsigned int sgm41513_get_vbus_stat(void);
extern unsigned int sgm41513_get_chrg_stat(void);
extern unsigned int sgm41513_get_vsys_stat(void);
//---------------------------------------------------------

extern unsigned int sgm41513_reg_config_interface(unsigned char RegNum,
		unsigned char val);

extern unsigned int sgm41513_read_interface(unsigned char RegNum,
		unsigned char *val, unsigned char MASK, unsigned char SHIFT);
extern unsigned int sgm41513_config_interface(unsigned char RegNum,
		unsigned char val, unsigned char MASK, unsigned char SHIFT);
