...
#if HYN_DEBUG_EN
#define HYN_DEBUG_LEVEL     2

#if (HYN_DEBUG_LEVEL == 2)
#define HYN_DEBUG(fmt, args...) printk(KERN_ERR "[HYN][%s:%d]"fmt"\n", __func__, __LINE__, ##args)
#define HYN_INFO(fmt, args...)  printk(KERN_ERR "[HYN][Info][%s:%d]"fmt"\n",__func__, __LINE__, ##args)
#define HYN_ERROR(fmt, args...) printk(KERN_ERR "[HYN][Error][%s:%d]"fmt"\n",__func__, __LINE__, ##args)
#else
