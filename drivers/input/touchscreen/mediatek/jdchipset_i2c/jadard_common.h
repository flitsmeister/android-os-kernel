...
#define JADARD_DRIVER_VER		 "01.73" /* MAJOR_VER.MINOR_VER */
#define JADARD_DRIVER_CID_VER	 "00.04" /* MAJOR_CID_VER.MINOR_CID_VER to TianLong  ADD ESD check*/
