...
//	printk("dsy log :   %s %d file name = %s \n",__FUNCTION__,__LINE__,BOOT_UPGRADE_FWNAME);
	...
	//	printk("dsy log :   %s %d  Not find FW in userspace, use embedded FW(size:%zu) \n",__FUNCTION__,__LINE__,g_embedded_fw.size);
		result = HX_EMBEDDED_FW;
#else
	//	printk("dsy log :   %s %d  \n",__FUNCTION__,__LINE__);
	//	printk("dsy log :   %s %d error code = %d \n",__FUNCTION__,__LINE__,ret);
...
//	printk("dsy log :   %s %d HX_RST_PIN_FUNC ts->rst_gpio =%d  \n",__FUNCTION__,__LINE__,ts->rst_gpio);
#endif
//	printk("dsy log :   %s %d  \n",__FUNCTION__,__LINE__);
