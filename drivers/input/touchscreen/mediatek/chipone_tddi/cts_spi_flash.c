...
static const struct cts_flash cts_flashes[] = {
    ...
    {"Boya,BY25Q20AW",
      0x681012,256, 0x1000, 0x8000, 0x40000},
    {"Boya,BY25Q40AW",
      0x681013,256, 0x1000, 0x8000, 0x80000},

    /* EON */
    { "EoN,EN25S20A",
      0x1C3812, 256, 0x1000, 0x8000, 0x40000},
    { "EoN,EN25S40A",
      0x1C3813, 256, 0x1000, 0x8000, 0x80000},
    /* XTXTECH */
    // { "XTX,XT25Q01",
    ...
    { "KangYong,XK25Q40T",
      0xEB6013, 256, 0x1000, 0x8000, 0x80000},

	 /*ZBIT*/
	{ "ZBIT,ZB25LD20B",
	  0x5E1012, 256, 0x1000, 0x8000, 0x40000},
	{ "ZBIT,ZB25LD40B",
	  0x5E1013, 256, 0x1000, 0x8000, 0x80000},

    /*FuDan*/
	{ "FD Micro.,FM25W02",
	  0xA12812, 256, 0x1000, 0x8000, 0x80000},
    { "FD Micro.,FM25W04",
	  0xA12813, 256, 0x1000, 0x8000, 0x80000},
};
