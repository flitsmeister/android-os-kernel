...
void check_update_flage(struct elan_ts_data *ts)
{
    ...
    */
    New_FW_ID = update_info->FwData[FW_ID_ADDR + 1] << 8 | update_info->FwData[FW_ID_ADDR];
    New_FW_VERSION = update_info->FwData[FW_VER_ADDR + 1] << 8 | update_info->FwData[FW_VER_ADDR];
