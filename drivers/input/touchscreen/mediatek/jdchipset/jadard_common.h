...
#define JADARD_DRIVER_VER        "01.89" /* MAJOR_VER.MINOR_VER */
#define JADARD_DRIVER_CID_VER    "00.05" /* MAJOR_CID_VER.MINOR_CID_VER ./add esd check */
 ...
 * MTK Platform DRM: JD_CONFIG_SPRD_DRM
...
extern void module_jd9366t_set_earphone_mode(unsigned int enable);
#endif
#if defined(CONFIG_TP_GET_CHARGE_MODE_STATUS)
extern void module_jd9366t_charg_mode_set(unsigned int enable);
#endif
